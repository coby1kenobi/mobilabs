...
// Many Thanks.
// mobilabcalib file was adapted from David Prentice's calibration file. 
// Manyt thanks for his work and help. 
...
int XP = 28, YP = A2, XM = A1, YM = 29;  //next common configuration
